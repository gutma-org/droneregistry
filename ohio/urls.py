...
urlpatterns = [
    ...
    path('api/v1/operators/<uuid:pk>/gutma-demo', registryviews.GUTMADemoOperator.as_view()),
    path('api/v1/operators/<uuid:pk>/rpas', registryviews.OperatorAircraft),
    path('api/v1/aircraft/<esn>', registryviews.AircraftESNDetails),    
    path('api/v1/aircraft/<uuid:pk>/gutma-demo', registryviews.GUTMADemoAircraft.as_view()),
    path('api/v1/contacts', registryviews.ContactList),
    path('api/v1/contacts/<uuid:pk>', registryviews.ContactDetail),
